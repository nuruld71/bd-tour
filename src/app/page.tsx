      ...
      <section className="relative">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-28 sm:px-6 lg:px-8 lg:py-40">
          <div className="max-w-2xl">
            <p className="inline-flex items-center rounded-full bg-brand-500/20 px-4 py-1.5 text-sm font-semibold text-brand-300 ring-1 ring-inset ring-brand-400/40">
